...
data['Dependent_count'] = st.selectbox("How many dependent relatives do you have ?", ['Select the number please','0','1','2','3','4','5','6'])
...
data['Months_on_book'] = st.slider("How long is the customer client in the bank ?", 13, 60, key="months_on_book'")
...
data['Total_Revolving_Bal'] = st.number_input("What is the total revolving balance on your credit card ?", min_value=0, max_value=3000, key="total_revolving_bal")

data['Total_Amt_Chng_Q4_Q1'] = st.number_input("How much did the customer's transaction amount change in the last quarter compared to the previous quarter?", min_value=0, max_value=5, key="total_amt_chng_Q4_Q1")
...
data['Total_Ct_Chng_Q4_Q1'] = st.number_input("How much did the customer's transaction amount changed in the last quarter compared to the previous one ?", min_value=0.00, max_value=5.00, key="total_ct_chng_Q4_Q1'")
